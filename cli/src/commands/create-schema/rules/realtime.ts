...
export const realtimeRule = {
  ...
  description: "Guidelines for creating database tables that support realtime updates",
  ...
  realtimeFields: [
    {
      ...
      type: "integer",
      isRequired: true,
      description: "Timestamp to track when a record was last updated (used for sync)"
    },
    {
      name: "version",
      type: "integer",
