    ...
    <div className="whitespace-normal [&_li>p]:inline [&_li>p]:m-0">
      <ReactMarkdown
        ...
        components={{
          ...
          ol: ({ className, ...props }) => (
            <ol
              className={cn("ml-5 list-decimal my-1", className)}
              {...props}
            />
          ),
          li: ({ className, ...props }) => (
            <li
              className={cn("my-0.5 marker:text-gray-400", className)}
              {...props}
            />
          ),
          ...
          pre: ({ className, ...props }) => (
            <pre
              className={cn(
                "overflow-x-auto rounded-lg bg-gray-900 p-3 text-white my-2",
                className,
              )}
              {...props}
            />
